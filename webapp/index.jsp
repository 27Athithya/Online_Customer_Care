...
<body>
  ...
  <header class="header" data-header>
    <div class="container">
      ...
      <a href="#" class="logo">
        <img src="img/logo.svg" alt="Ridex logo">
      </a>
      ...
      <div class="header-actions">
        ...
        <a href="profile.jsp" class="btn user-btn" aria-label="Profile">
          <ion-icon name="person-outline"></ion-icon>
        </a>
        
        
          <!-- 🔔 Notification button -->
  			<!--  <a href="javascript:void(0)" class="btn notification-btn" aria-label="Notifications" onclick="toggleNotifications()" >
     ...
     <!-- Notification Sidebar (Initially Hidden) -->
    	  <div id="notificationSidebar" class="notification-sidebar hidden">
  		<!-- Notifications will be inserted here via fetch -->
		</div>
...
<section class="section featured-car" id="featured-car">
        <div class="container">
          ...
          <ul class="featured-car-list">
            <c:forEach var="vehicle" items="${vehicleDAO.all}">
              <li>
                <div class="featured-car-card">
                  <figure class="card-banner">
                    <img src="${vehicle.vehicleImage}" alt="${vehicle.vehicleName}" loading="lazy" width="440" height="300" class="w-100">
                  </figure>

                  <div class="card-content">
                    <div class="card-title-wrapper">
                      <h3 class="h3 card-title">
                        <a href="#">${vehicle.vehicleName}</a>
                      </h3>
                      <data class="year" value="${vehicle.manufactureYear}">${vehicle.manufactureYear}</data>
                    </div>

                    <ul class="card-list">
                      <li class="card-list-item">
                        <ion-icon name="people-outline"></ion-icon>
                        <span class="card-item-text">${vehicle.personCapacity} People</span>
                      </li>

                      <li class="card-list-item">
                        <ion-icon name="flash-outline"></ion-icon>
                        <span class="card-item-text">${vehicle.fuelType}</span>
                      </li>

                      <li class="card-list-item">
                        <ion-icon name="speedometer-outline"></ion-icon>
                        <span class="card-item-text">${vehicle.literPerKm}km / 1-litre</span>
                      </li>

                      <li class="card-list-item">
                        <ion-icon name="hardware-chip-outline"></ion-icon>
                        <span class="card-item-text">${vehicle.transmissionType}</span>
                      </li>
                    </ul>

                    <div class="card-price-wrapper">
                      <p class="card-price">
                        <strong>$${vehicle.rentPerDay}</strong> / day
                      </p>
